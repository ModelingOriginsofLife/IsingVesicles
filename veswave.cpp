...
This version drives the temperature up and down.
************/
...
int main(int argc, char **argv)
{
    ...
    phase = 0;
    float tinc = (TEMP) / period;
    TEMP = TEMP/2;              // swing from (initial TEMP)/2 to 3*TEMP/2 and back
    for(cnt = 0;1;cnt++)
	{
		int Ch=ReadKey();
